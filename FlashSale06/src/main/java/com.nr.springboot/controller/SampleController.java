...
import com.nr.springboot.rabbitmq_demo.MQSender;
...
//	
    ...
    @ResponseBody
    public Result<String> direct01() {
        sender.sendDirect01("hello,red");
        return Result.success("Hello，world");
    }

    @RequestMapping("/mq/direct02")
    @ResponseBody
    public Result<String> direct02() {
        sender.sendDirect02("hello,green");
        return Result.success("Hello，world");
    }
